...
<template>
  ...
  >
    ...
    <main class="sakura-sidebar-offset sakura-main">
      <div id="sakura-main-layout-before">
        <slot name="main-layout-before" />
      </div>
      <SakuraLayout>
        <div id="sakura-main-layout-content-before">
          <slot name="main-layout-content-before" />
        </div>
        <slot>
        ...
        <div id="sakura-main-layout-content-after">
          <slot name="main-layout-content-after" />
        </div>
      </SakuraLayout>
      <div id="sakura-main-layout-after">
        <slot name="main-layout-after" />
      </div>
    </main>
...
.sakura-sidebar-offset {
  ...
  transition: transform var(--va-transition-duration) cubic-bezier(0.19, 1, 0.22, 1);
}
</style>
