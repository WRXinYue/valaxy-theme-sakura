...
declare module 'vue-router/auto-routes' {
  ...
  export interface RouteNamedMap {
    ...
    '/components/article-list': RouteRecordInfo<'/components/article-list', '/components/article-list', Record<never, never>, Record<never, never>>,
    '/components/article-pinned': RouteRecordInfo<'/components/article-pinned', '/components/article-pinned', Record<never, never>, Record<never, never>>,
    '/components/background-display': RouteRecordInfo<'/components/background-display', '/components/background-display', Record<never, never>, Record<never, never>>,
    '/components/banner': RouteRecordInfo<'/components/banner', '/components/banner', Record<never, never>, Record<never, never>>,
    '/components/banner-overlay-bar': RouteRecordInfo<'/components/banner-overlay-bar', '/components/banner-overlay-bar', Record<never, never>, Record<never, never>>,
    '/components/footer': RouteRecordInfo<'/components/footer', '/components/footer', Record<never, never>, Record<never, never>>,
    '/components/info-overlay': RouteRecordInfo<'/components/info-overlay', '/components/info-overlay', Record<never, never>, Record<never, never>>,
