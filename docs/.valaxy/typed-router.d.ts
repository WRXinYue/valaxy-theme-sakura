...
declare module 'vue-router/auto-routes' {
  ...
  export interface RouteNamedMap {
    ...
    '/components/SakuraPost': RouteRecordInfo<'/components/SakuraPost', '/components/SakuraPost', Record<never, never>, Record<never, never>>,
    '/components/SakuraPostCategories': RouteRecordInfo<'/components/SakuraPostCategories', '/components/SakuraPostCategories', Record<never, never>, Record<never, never>>,
    '/components/SakuraPostCollapse': RouteRecordInfo<'/components/SakuraPostCollapse', '/components/SakuraPostCollapse', Record<never, never>, Record<never, never>>,
    '/components/SakuraPostFooter': RouteRecordInfo<'/components/SakuraPostFooter', '/components/SakuraPostFooter', Record<never, never>, Record<never, never>>,
    '/components/SakuraPostTags': RouteRecordInfo<'/components/SakuraPostTags', '/components/SakuraPostTags', Record<never, never>, Record<never, never>>,
    ...
    '/components/SakuraScrollToTop': RouteRecordInfo<'/components/SakuraScrollToTop', '/components/SakuraScrollToTop', Record<never, never>, Record<never, never>>,
    ...
    '/components-custom/SakuraPostFooterCustom': RouteRecordInfo<'/components-custom/SakuraPostFooterCustom', '/components-custom/SakuraPostFooterCustom', Record<never, never>, Record<never, never>>,
    '/components-custom/SakuraPostListCustom': RouteRecordInfo<'/components-custom/SakuraPostListCustom', '/components-custom/SakuraPostListCustom', Record<never, never>, Record<never, never>>,
    '/components-custom/SakuraPostPinnedCustom': RouteRecordInfo<'/components-custom/SakuraPostPinnedCustom', '/components-custom/SakuraPostPinnedCustom', Record<never, never>, Record<never, never>>,
    ...
    '/components-themes/PostListThemeCard': RouteRecordInfo<'/components-themes/PostListThemeCard', '/components-themes/PostListThemeCard', Record<never, never>, Record<never, never>>,
    '/components-themes/PostListThemeGrid': RouteRecordInfo<'/components-themes/PostListThemeGrid', '/components-themes/PostListThemeGrid', Record<never, never>, Record<never, never>>,
    '/components-themes/PostListThemeMasonry': RouteRecordInfo<'/components-themes/PostListThemeMasonry', '/components-themes/PostListThemeMasonry', Record<never, never>, Record<never, never>>,
    '/components-themes/PostListThemeMinima': RouteRecordInfo<'/components-themes/PostListThemeMinima', '/components-themes/PostListThemeMinima', Record<never, never>, Record<never, never>>,
    '/components-themes/PostNavigationThemeMinimal': RouteRecordInfo<'/components-themes/PostNavigationThemeMinimal', '/components-themes/PostNavigationThemeMinimal', Record<never, never>, Record<never, never>>,
    '/components-themes/PostNavigationThemeSakura': RouteRecordInfo<'/components-themes/PostNavigationThemeSakura', '/components-themes/PostNavigationThemeSakura', Record<never, never>, Record<never, never>>,
    '/components-themes/PostPinnedThemeStartDash': RouteRecordInfo<'/components-themes/PostPinnedThemeStartDash', '/components-themes/PostPinnedThemeStartDash', Record<never, never>, Record<never, never>>,
    '/components-themes/PostThemeCard': RouteRecordInfo<'/components-themes/PostThemeCard', '/components-themes/PostThemeCard', Record<never, never>, Record<never, never>>,
    '/components-themes/PostThemeGrid': RouteRecordInfo<'/components-themes/PostThemeGrid', '/components-themes/PostThemeGrid', Record<never, never>, Record<never, never>>,
    '/components-themes/PostThemeMasonry': RouteRecordInfo<'/components-themes/PostThemeMasonry', '/components-themes/PostThemeMasonry', Record<never, never>, Record<never, never>>,
    '/components-themes/PostThemeMinima': RouteRecordInfo<'/components-themes/PostThemeMinima', '/components-themes/PostThemeMinima', Record<never, never>, Record<never, never>>,
    ...
    '/config/layouts': RouteRecordInfo<'/config/layouts', '/config/layouts', Record<never, never>, Record<never, never>>,
