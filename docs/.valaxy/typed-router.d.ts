...
declare module 'vue-router/auto-routes' {
  ...
  export interface RouteNamedMap {
    ...
    '/guide/special-pages': RouteRecordInfo<'/guide/special-pages', '/guide/special-pages', Record<never, never>, Record<never, never>>,
    ...
    '/guide/theme-config/other': RouteRecordInfo<'/guide/theme-config/other', '/guide/theme-config/other', Record<never, never>, Record<never, never>>,
    '/guide/theme-config/pagination': RouteRecordInfo<'/guide/theme-config/pagination', '/guide/theme-config/pagination', Record<never, never>, Record<never, never>>,
