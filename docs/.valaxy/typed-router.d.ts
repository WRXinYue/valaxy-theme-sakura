...
declare module 'vue-router/auto-routes' {
  ...
  export interface RouteNamedMap {
    ...
    '/components/SakuraArticleNavigation': RouteRecordInfo<'/components/SakuraArticleNavigation', '/components/SakuraArticleNavigation', Record<never, never>, Record<never, never>>,
    '/components/SakuraArticleNavigationMinimal': RouteRecordInfo<'/components/SakuraArticleNavigationMinimal', '/components/SakuraArticleNavigationMinimal', Record<never, never>, Record<never, never>>,
    ...
    '/config/style': RouteRecordInfo<'/config/style', '/config/style', Record<never, never>, Record<never, never>>,
